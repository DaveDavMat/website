    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        ...
        if(isset($_SESSION["loginSuccess"]))
        {
                ...
                {
                        echo '<strong>Witaj użytkowniku!</strong>
                        <a href="wyloguj.php class="btn btn-success">Wyloguj</a>';
                }else
                {
                        echo '<div id="navbar" class="navbar-collapse collapse">
          <form class="navbar-form navbar-right" role="form" method="POST" action="zaloguj.php">
            ...
            <button type="submit" class="btn btn-success" >Zaloguj się</button>
               <button formaction="rejestracja.php" class="btn btn-success">Zarejestruj</button>
          </form>';
