...
<html class="no-js" lang="pl"> 
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="rejestracja.php"><span class="glyphicon glyphicon-user"></span>Rejestracja</a></li>
      <li class="active"><a href="logform.php"><span class="glyphicon glyphicon-log-in"></span>Zaloguj</a></li>
    </ul>';
                          }
                }else{
