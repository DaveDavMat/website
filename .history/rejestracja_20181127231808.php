...
$redirectURL = 'https://72b665c9.ngrok.io/Sklep/fb-callback.php';
$permissions = ['email'];
...
<div class="container">
  ...
  <div class="logright">
    ...
    <button class="social-signin facebook" onclick="window.location = '<?php echo $loginURL ?>';" >Log in with facebook</button>
