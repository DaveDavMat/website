...
<?php
function WyswLog (){
return echo '<form method="POST" action="zaloguj.php" class="navbar-form navbar-right" role="form">
...
var_dump($_SESSION);
                if(isset($_SESSION['loginSuccess'])){
                        if($_SESSION['loginSuccess'] == true){
                                ...
                                ";
                        }else{ echo '<form method="POST" action="zaloguj.php" class="navbar-form navbar-right" role="form">
                             <div class="form-group">
                                  <input type="text" placeholder="Adres email" class="form-control" name="email">
                              </div>
                             <div class="form-group">
